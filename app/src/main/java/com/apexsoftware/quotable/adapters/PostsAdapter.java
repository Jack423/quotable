...
import com.apexsoftware.quotable.adapters.holders.LoadViewHolder;
...
public class PostsAdapter extends BasePostsAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ItemType.ITEM.getTypeCode()) {
            return new PostViewHolder(inflater.inflate(R.layout.post_item_list_view_new, parent, false),
