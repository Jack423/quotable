...
public class LoginActivityOld extends AppCompatActivity {
        ...
        ProfileManager.getInstance(this).isProfileExist(userId, new OnObjectExistListener<Profile>() {
            ...
            public void onDataChanged(boolean exist) {
                if (!exist) {
                    ...
                    PreferencesUtil.setProfileCreated(LoginActivityOld.this, true);
                    //DatabaseHelper.getInstance(LoginActivityOld.this.getApplicationContext())
    ...
    private void startCreateProfileActivity() {
        Intent intent = new Intent(LoginActivityOld.this, CreateProfileActivity.class);
