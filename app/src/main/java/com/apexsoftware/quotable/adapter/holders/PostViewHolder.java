...
public class PostViewHolder extends RecyclerView.ViewHolder implements AppCompatCallback{
    ...
    public PostViewHolder(View view, final OnClickListener onClickListener, boolean isAuthorNeeded) {
        ...
        userManager = ProfileManager.getInstance(context.getApplicationContext());
        ...
        reference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (user != null) {
                    ...
                    StorageReference storageReference = FirebaseStorage.getInstance().getReference("images/user_" + user.getId());
                    GlideApp.with(context).load(storageReference).centerCrop().placeholder(R.drawable.ic_stub).into(authorImageView);
                } else {
